import { IAccountUser } from '@/features/auth/types/IUser'
      ...
      <ListboxWrapper>
        ...
        <Listbox aria-label="Actions" className="ml-6 mr-2 ">
          <ListboxItem
            ...
            className={selectedItem === 'new' ? 'text-gray-400' : 'text-black'}
          >
            New file
          </ListboxItem>
          <ListboxItem
            ...
            className={selectedItem === 'copy' ? 'text-gray-400' : 'text-black'}
          >
            Copy link
          </ListboxItem>
