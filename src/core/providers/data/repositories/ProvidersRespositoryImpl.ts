...
import { ProvidersDataSource, ProvidersDataSourceImpl } from "../datasource/providers-datasource";
...
export class ProvidersRepositoryImpl implements ProvidersRepository {
  ...
  getAllCertificateTypes = async () => await this.datasource.getAllCertificateTypes()

  getAllCertificateStatus = async () => await this.datasource.getAllCertificateStatus()

  getAllDegreeModalities = async () => await this.datasource.getAllDegreeModalities()
